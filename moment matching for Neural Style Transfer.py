...
class CMDStyleTransfer:
    ...
    def run(self, vgg_weights, alpha=0.9, style_loss_weights=(1, 1, 1, 1, 1), epsilon=0.0001, max_iter=500):
        ...
        print(convs_s[0].shape)
        print(convs_s[1].shape)
        ...
        while iteration < max_iter:
            ...
            for i, (conv_o, conv_s) in enumerate(zip(outputs, convs_s)):
                # print(f'o_size {conv_o.shape}, s_size {conv_s.shape}\n')
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--c_img', type=str, default='/content/gdrive/Shareddrives/GenAI/Image_Style_Transfer/Images/content/building.png', help='Path to content image')
    ...
    parser.add_argument('--c_img', type=str, default='/content/gdrive/Shareddrives/GenAI/Image_Style_Transfer/Images/content/NY.png', help='Path to content image')
    parser.add_argument('--s_img', type=str, default='/content/gdrive/Shareddrives/GenAI/Image_Style_Transfer/Images/style/label_5_image_61.png', help='Path to style image')
    ...
    if False:
        ...
        saveName = os.path.join('/content/gdrive/Shareddrives/GenAI/Image_Style_Transfer/Images/generated_images/VGG/', saveName)
